...
import type { EscenarioResultado } from "@/types";
...
export function ScenarioChart({ results }: { results: EscenarioResultado[] }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5">
      <h3 className="text-slate-700 dark:text-slate-200 font-semibold text-sm mb-4">Comparación Detallada de Escenarios</h3>
